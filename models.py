...
class Tai_xe(Base):
    ...
    tai_xe_xe = relationship( "Xe" , secondary = association_table_xetaixe , back_populates="xe_tai_xe")

    
    #lien ket voi chuyen xe theo many to many

    tai_xe_chuyen_xe = relationship( "Chuyen_xe" , secondary= association_table_taixe_chuyenxe , back_populates="chuyen_xe_tai_xe" )
...
class Chuyen_xe(Base):
    ...
    chuyen_xe_tai_xe = relationship( "Tai_xe" , secondary= association_table_taixe_chuyenxe , back_populates="tai_xe_chuyen_xe" )
